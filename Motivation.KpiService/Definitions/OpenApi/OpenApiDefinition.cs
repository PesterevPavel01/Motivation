...
namespace Motivation.KpiService.Definitions.OpenApi
{
    /// <summary>
    ...
    public class OpenApiDefinition : AppDefinition
    {
        ...
        public override void ConfigureApplication(WebApplication app)
        {
            ...
            {
                settings.SwaggerEndpoint(_openApiConfig, $"Kpi service v.{AppVersion}");

                settings.DocumentTitle = "Kpi service";
                ...
                settings.OAuthAppName("Kpi service");
