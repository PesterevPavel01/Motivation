...
namespace Motivation.HRService.Definitions.OpenApi
{
    /// <summary>
    ...
    public class OpenApiDefinition : AppDefinition
    {
        ...
        public override void ConfigureApplication(WebApplication app)
        {
            ...
            {
                settings.SwaggerEndpoint(_openApiConfig, $"HR service v.{AppVersion}");

                settings.DocumentTitle = "HR service";
                ...
                settings.OAuthAppName("HR service");
