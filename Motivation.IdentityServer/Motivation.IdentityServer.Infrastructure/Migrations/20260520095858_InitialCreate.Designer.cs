...
namespace Motivation.IdentityServer.Infrastructure.Migrations
{
    ...
    [Migration("20260520095858_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Motivation.IdentityServer.Domain.EventItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Motivation.IdentityServer.Infrastructure.AppPermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Motivation.IdentityServer.Infrastructure.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Motivation.IdentityServer.Infrastructure.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Motivation.IdentityServer.Infrastructure.ApplicationUserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Motivation.IdentityServer.Infrastructure.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Motivation.IdentityServer.Infrastructure.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Motivation.IdentityServer.Infrastructure.AppPermission", b =>
                {
                    b.HasOne("Motivation.IdentityServer.Infrastructure.ApplicationUserProfile", "ApplicationUserProfile")
            ...
            modelBuilder.Entity("Motivation.IdentityServer.Infrastructure.ApplicationUser", b =>
                {
                    b.HasOne("Motivation.IdentityServer.Infrastructure.ApplicationUserProfile", "ApplicationUserProfile")
                        ...
                        .HasForeignKey("Motivation.IdentityServer.Infrastructure.ApplicationUser", "ApplicationUserProfileId");
